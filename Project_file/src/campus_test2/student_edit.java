 ...
 * @author hp
 */
public class student_edit extends javax.swing.JInternalFrame {
    ...
    public student_edit() {
        ...
        try
        {
            ...
            String[] date_of_birth = rs_1.getString("date_of_birth").split("-") ;
                year.setSelectedItem(date_of_birth[0]);
                month.setSelectedItem(date_of_birth[1]);
                date.setSelectedItem(date_of_birth[2]);
            grade.setSelectedItem(rs_1.getObject("class"));
            Stext3.setText(rs_1.getString("phone_number"));
            
            //subject
            jComboBox1.setSelectedItem(rs_1.getObject("section"));
            Stext4.setText(rs_1.getString("subjects"));
    ...
    public void edit_account(){
        ...
        if ( user_name1.equals(user_name2) )
        {
            if ( user_password1.equals(user_password2) )
            {
                ...
                try
                {
                    String q = "UPDATE `student` SET full_name='"+full_name+"' , address='"+address+"' , date_of_birth='"+date_of_birth+"' , class='"+clas+"' , phone_number='"+phone_no+"' , section='"+section+"' , subjects='"+subjects+"' , user_name='"+user_name1+"' , user_password='"+user_password1+"' WHERE student_id='"+rs_1.getString("student_id")+"' ";
                    pst = con.prepareStatement(q) ;
                    Statement st = con.createStatement() ;
                    st.executeUpdate(q) ;
                    
                    JOptionPane.showMessageDialog(null, "Your Account is Edit ");
                }
                catch (Exception e)
                {
